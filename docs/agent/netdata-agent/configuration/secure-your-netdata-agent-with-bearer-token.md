...
Your agent must be [claimed to Netdata Cloud](/docs/agent/src/claim) to use this feature.
...
Edit your `netdata.conf` using the [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files) script:
...
- **TLS/SSL encryption**: Configure [TLS in Netdata](/docs/agent/src/web/server#examples) for encrypted connections
