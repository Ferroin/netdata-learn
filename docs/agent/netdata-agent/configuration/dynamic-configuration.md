...
> **Info**
>
> To understand what actions users can perform based on their role, refer to the [Role Based Access documentation](/docs/agent/netdata-cloud/authentication-and-authorization/role-based-access-model#dynamic-configuration-manager).
...
Each template can have multiple items which resemble Alerts that either apply to a certain [instance](/docs/dashboards-and-charts/netdata-charts#instances-dropdown), or all instances under a specific [context](/docs/dashboards-and-charts/netdata-charts#contexts)
