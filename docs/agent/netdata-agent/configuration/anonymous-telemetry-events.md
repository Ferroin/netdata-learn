...
See the [Docker installation guide](/docs/agent/packaging/docker#create-a-new-netdata-agent-container) for complete configuration.
...
See the [installation documentation](/docs/agent/packaging/installer) for available installer scripts.
...
- [Installation methods](/docs/agent/packaging/installer) - Complete installation guides
- [Docker installation](/docs/agent/packaging/docker) - Container-specific setup
- [Windows installation](/docs/agent/packaging/windows/windows_installer) - Windows Agent setup
