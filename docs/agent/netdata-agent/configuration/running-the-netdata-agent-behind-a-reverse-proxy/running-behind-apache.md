...
If you use Netdata Cloud, [Bearer Token Protection](/docs/agent/netdata-agent/configuration/secure-your-netdata-agent-with-bearer-token) provides authentication with a single setting - no htpasswd files or Apache auth configuration needed.
