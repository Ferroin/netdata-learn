...
| [Change how long Netdata stores metrics](/docs/agent/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage) |                    | :heavy_check_mark: | :heavy_check_mark: |
| [Use a different metric storage database](/docs/agent/src/database)              |                    | :heavy_check_mark: | :heavy_check_mark: |
...
possible [process scheduling policy](/docs/agent/src/daemon#netdata-process-scheduling-policy),
...
2. [Change how long Netdata stores metrics](/docs/agent/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage)
3. [Use a different metric storage database](/docs/agent/src/database).
...
1. [Change how long Netdata stores metrics](/docs/agent/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage).

To control disk I/O:

1. [Use a different metric storage database](/docs/agent/src/database),
...
using [streaming and replication](/docs/agent/observability-centralization-points).
...
See [using a different metric storage database](/docs/agent/src/database).

## Disable unneeded plugins or collectors

If you know that you don't need an [entire plugin or a specific
collector](/docs/agent/src/collectors#collector-architecture-and-terminology),
...
dashboard, [configure the Agent](/docs/agent/netdata-agent/configuration) to collect
metrics less often.
...
the [collectors configuration reference](/docs/agent/src/collectors/reference) for
details.

To reduce the frequency of
an [internal_plugin/collector](/docs/agent/src/collectors#collector-architecture-and-terminology),
...
To [configure an individual collector](/docs/agent/src/collectors/reference#configure-a-collector),
...
See how
to [change how long Netdata stores metrics](/docs/agent/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage).

## Use a different metric storage database

Consider [using a different metric storage database](/docs/agent/src/database)
when running Netdata on IoT devices, and for children in a parent-child set up based
on [streaming and replication](/docs/agent/observability-centralization-points).
...
internal [web server](/docs/agent/src/web).
...
see [reverse proxies](/docs/agent/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy).
