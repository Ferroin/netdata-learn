...
- **Machine Learning**: Trains anomaly detection models for each metric ([Anomaly Detection](/docs/agent/src/ml))
...
See [Resource Utilization](/docs/agent/netdata-agent/sizing-netdata-agents) for detailed Agent resource requirements.
...
:::tip
This architecture works especially well in production environments where you monitor many systems. Learn more in our [Centralization Points documentation](/guides/deployment-with-centralization-points).
:::

## Disable unneeded collectors

Reduce resource usage by turning off [Plugins or Collectors](/docs/agent/src/collectors) you don't need.
...
Follow our [configuration guide](/docs/agent/src/collectors/reference) to identify and disable specific collectors.
...
Learn how to adjust collection frequency in our [configuration guide](/docs/agent/src/collectors/reference).
...
Configure retention settings using our [database configuration guide](/docs/agent/src/database/configuration).

## Switch to RAM mode

For IoT devices and Child nodes in [Parent-Child setups](/guides/deployment-with-centralization-points), switch to RAM mode to eliminate disk operations entirely. This mode:
...
Set up RAM mode following our [database configuration guide](/docs/agent/src/database/configuration).
...
To disable ML, edit your configuration using [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files):
