...
Netdata's CPU usage depends on the features you enable. For details, see [resource utilization](/docs/agent/netdata-agent/sizing-netdata-agents).
...
- Alerts
- Streaming to a [Parent Agent](/docs/agent/observability-centralization-points/metrics-centralization-points)
