...
For a quick introduction, read our [exporting metrics overview](/docs/agent/exporting-metrics) or start with [enabling a connector](/docs/agent/exporting-metrics/enable-an-exporting-connector).
...
When you enable the exporting engine, Netdata exports metrics **starting from the restart time**, not the entire [historical database](/docs/agent/src/database).
...
|:----------------------------------------------------------------------------|:---------------------------|:-----------------------------------|
| [AWS Kinesis](/docs/agent/src/exporting/aws_kinesis)                         | JSON                       | Stream-based                       |
| [Google Pub/Sub](/docs/agent/src/exporting/pubsub)                           | JSON                       | Message-based                      |
| [Graphite](/docs/agent/src/exporting/graphite)                               | Plaintext                  | `prefix.hostname.chart.dimension`  |
| [JSON Databases](/docs/agent/src/exporting/json)                             | JSON                       | Document-based                     |
| [OpenTSDB](/docs/agent/src/exporting/opentsdb)                               | Plaintext/HTTP             | `prefix.chart.dimension` with tags |
| [MongoDB](/docs/agent/src/exporting/mongodb)                                 | JSON                       | Document-based                     |
| [Prometheus](/docs/agent/src/exporting/prometheus)                           | HTTP scraping              | Prometheus exposition format       |
| [Prometheus Remote Write](/docs/agent/src/exporting/prometheus/remote_write) | Snappy-compressed protobuf | Binary over HTTP                   |
| [TimescaleDB](/docs/agent/src/exporting/timescale)                                  | JSON streams               | Time-series tables                 |
...
For the complete naming rules — contexts, units, suffixes, and how to preview the exact metric names via the `allmetrics` endpoint — see the [Prometheus reference](/docs/agent/src/exporting/prometheus).
...
Both approaches respect the `send names instead of ids` setting: when enabled, Netdata uses human-friendly chart and dimension names; when disabled, it uses the raw system IDs. See the [OpenTSDB connector options](/docs/agent/src/exporting/opentsdb) for the prefix and name settings.
...
- [Nginx reverse proxy setup](/docs/agent/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/running-behind-nginx)
