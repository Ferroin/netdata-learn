...
All capabilities are set automatically during Netdata installation using the [official installation method](/docs/agent/packaging/installer/methods/kickstart).
...
Netdata [config directory](/docs/agent/netdata-agent/configuration#locate-your-config-directory),
...
Then [restart netdata](/docs/agent/netdata-agent/start-stop-restart) for the change to take effect.
