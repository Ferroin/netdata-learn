...
the [official installation method](/docs/agent/packaging/installer/methods/kickstart).
...
Read [how to write a Netdata collector in Go](/docs/agent/src/go/plugin/go.d/docs/how-to-write-a-module).
