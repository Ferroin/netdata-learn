...
- [HTTP Endpoints](/docs/agent/src/go/plugin/go.d/collector/httpcheck/integrations/http_endpoints)
- [Web server log files](/docs/agent/src/go/plugin/go.d/collector/weblog/integrations/web_server_log_files)
- [Applications](/docs/agent/src/collectors/apps.plugin/integrations/applications)
- [Containers](/docs/agent/src/collectors/cgroups.plugin/integrations/containers)
