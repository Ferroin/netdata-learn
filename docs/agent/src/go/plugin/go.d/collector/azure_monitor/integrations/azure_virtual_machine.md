...
| **Virtual Node** | [vnode](#option-virtual-node-vnode) | Associates this job with a [Virtual Node](/docs/netdata-agent/configuration/organize-systems-metrics-and-alerts#virtual-nodes). |  | no |
