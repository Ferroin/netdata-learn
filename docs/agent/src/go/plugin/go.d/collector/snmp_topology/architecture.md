...
See the [diagnostics tool](/docs/agent/src/go/tools/snmp-diagnostics#collection-cost) for interpretation and exclusions.
...
[Collect SNMP troubleshooting data](/docs/agent/npm/device-metrics/collect-snmp-troubleshooting-data)
...
The [tool README](/docs/agent/src/go/tools/snmp-diagnostics#usage) owns supported inputs, selectors, operations, and
