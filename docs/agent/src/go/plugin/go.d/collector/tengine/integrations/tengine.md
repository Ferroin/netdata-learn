...
To enable the module, see the [official documentation](/docs/agent/src/go/plugin/go.d/collector/tengine/integrations/ngx_http_reqstat_module](https:/tengine.taobao.org/document/http_reqstat.html).
