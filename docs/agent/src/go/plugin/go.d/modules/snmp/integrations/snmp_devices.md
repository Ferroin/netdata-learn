...
| network_interface_filter.by_name | Filter interfaces by their names using [simple patterns](/docs/agent/src/libnetdata/simple_pattern#simple-patterns). |  | no |
| network_interface_filter.by_type | Filter interfaces by their types using [simple patterns](/docs/agent/src/libnetdata/simple_pattern#simple-patterns). |  | no |
