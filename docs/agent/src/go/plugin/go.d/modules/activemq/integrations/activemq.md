...
| queues_filter | Queues filter. Syntax is [simple patterns](/docs/agent/src/libnetdata/simple_pattern#simple-patterns). |  | no |
| topics_filter | Topics filter. Syntax is [simple patterns](/docs/agent/src/libnetdata/simple_pattern#simple-patterns). |  | no |
