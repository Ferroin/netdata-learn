...
Common helpers live in [`../framework`](/docs/agent/src/go/plugin/framework) and [`../protocols`](/docs/agent/src/go/plugin/protocols). When adding a new module, follow the workflow described there and ensure `go generate` keeps metadata in sync.
