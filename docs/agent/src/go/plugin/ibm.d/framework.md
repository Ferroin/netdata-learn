...
- [`../README.md`](/docs/agent/src/go/plugin/ibm.d/..) – project overview, build instructions, and directory map
- [`../AGENTS.md`](/docs/agent/src/go/plugin/agents) – authoring checklist and best practices for AI assistants
- [`../../../AGENTS.md`](/docs/agent/src/agents) – Go-area rules and routing
