...
This guide is for developers contributing to the IBM.d plugin. For end-user documentation, see [README.md](/docs/agent/src/go/plugin/ibm.d/.).
...
| Path | Purpose |
|------|---------|
| `framework/` | IBM.D collector SDK: base collector, context helpers, generator tooling. See [`framework/README.md`](/docs/agent/src/go/plugin/ibm.d/framework). |
...
1. Review [`framework/README.md`](/docs/agent/src/go/plugin/ibm.d/framework) for IBM.D framework details.
2. Follow the Go-area rules in [`../../AGENTS.md`](/docs/agent/src/go/agents).
