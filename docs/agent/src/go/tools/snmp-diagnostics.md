...
emission](/docs/agent/src/go/plugin/go.d/collector/snmp/architecture#metric-emission) section for row identity and accumulation,
and the profile guide's [virtual metrics](/docs/agent/src/go/plugin/go.d/collector/snmp/profile-format#virtual-metrics) section
...
- [BGP collection and retained rows](/docs/agent/src/go/plugin/go.d/collector/snmp/architecture#bgp-collection-and-retained-rows)
- [Licensing normalization and collection results](/docs/agent/src/go/plugin/go.d/collector/snmp/architecture#licensing-normalization-and-collection-results)
...
[Offline Diagnostic Inspection](/docs/agent/src/go/plugin/go.d/collector/snmp_topology/architecture#offline-diagnostic-inspection).
