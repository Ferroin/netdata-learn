...
Netdata's [Prometheus profile workflow](/docs/.github/workflows/prometheus-profile-tests.yml):
...
- [Stock proof artifact and checkout contract](/docs/agent/src/plugin/go.d/collector/prometheus/profile-proofs)
- [Proof CLI behavior](/docs/agent/src/tools/prometheus-profile-proof)
- [Standalone validator behavior and findings](/docs/agent/src/tools/prometheus-profile-validation)
- [Profile and proof authoring workflow](/docs/.agents/skills/collectors-prometheus-profiles/skill)
- [Strict proof authoring reference](/docs/.agents/skills/collectors-prometheus-profiles/proof-authoring)
