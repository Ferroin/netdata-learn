...
- [Profile and proof authoring workflow](/docs/.agents/skills/project-prometheus-profiles/skill)
- [Strict proof authoring reference](/docs/.agents/skills/project-prometheus-profiles/proof-authoring)
