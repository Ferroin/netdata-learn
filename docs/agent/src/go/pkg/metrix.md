...
**See also**: [charttpl](/docs/agent/src/go/plugin/framework/charttpl) (template DSL),
[chartengine](/docs/agent/src/go/plugin/framework/chartengine) (compile + plan),
[how-to-write-a-collector.md](/docs/agent/src/go/plugin/go.d/docs/how-to-write-a-collector) (end-to-end integration).
...
[how-to-write-a-collector.md](/docs/agent/src/go/plugin/go.d/docs/how-to-write-a-collector).
