...
The Value formatter presents [results of database queries](/docs/agent/src/web/api/queries) as a single value.
...
Instead it is used by the [`ssv`](/docs/agent/src/web/api/formatters/ssv) formatter
and [health monitoring queries](/docs/agent/src/health).
