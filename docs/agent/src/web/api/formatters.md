...
|:----:|:----:|:----------:|:----------|
| `array`|[ssv](/docs/agent/src/web/api/formatters/ssv)|application/json|a JSON array|
| `csv`|[csv](/docs/agent/src/web/api/formatters/csv)|text/plain|a text table, comma separated, with a header line (dimension names) and `\r\n` at the end of the lines|
| `csvjsonarray`|[csv](/docs/agent/src/web/api/formatters/csv)|application/json|a JSON array, with each row as another array (the first row has the dimension names)|
| `datasource`|[json](/docs/agent/src/web/api/formatters/json)|application/json|a Google Visualization Provider `datasource` javascript callback|
| `datatable`|[json](/docs/agent/src/web/api/formatters/json)|application/json|a Google `datatable`|
| `html`|[csv](/docs/agent/src/web/api/formatters/csv)|text/html|an html table|
| `json`|[json](/docs/agent/src/web/api/formatters/json)|application/json|a JSON object|
| `jsonp`|[json](/docs/agent/src/web/api/formatters/json)|application/json|a JSONP javascript callback|
| `markdown`|[csv](/docs/agent/src/web/api/formatters/csv)|text/plain|a markdown table|
| `ssv`|[ssv](/docs/agent/src/web/api/formatters/ssv)|text/plain|a space separated list of values|
| `ssvcomma`|[ssv](/docs/agent/src/web/api/formatters/ssv)|text/plain|a comma separated list of values|
| `tsv`|[csv](/docs/agent/src/web/api/formatters/csv)|text/plain|a TAB delimited `csv` (MS Excel flavor)|
