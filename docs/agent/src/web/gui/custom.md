...
If you have ephemeral monitoring setup ([More info here](/docs/agent/src/streaming#monitoring-ephemeral-nodes)) and have no
...
patterns](/docs/agent/src/libnetdata/simple_pattern) for dimensions. By default it
...
You can append Netdata **[REST API v1](/docs/agent/src/web/api)** data options, using this:
