...
Edit `netdata.conf` using the [`edit-config` script](/docs/agent/netdata-agent/configuration)
...
| `accept a streaming request every` | `off`                                                                                                                                                                                  | Can be used to set a limit on how often a parent node will accept streaming requests from child nodes in a [streaming and replication setup](/docs/agent/src/streaming).                                                                                                                                                                                                                                  |
...
| `custom dashboard_info.js`         | ``                                                                                                                                                                                     | Specifies the location of a custom `dashboard.js` file. See [customizing the standard dashboard](/docs/agent/developer-and-contributor-corner/customize#customize-the-standard-dashboard) for details.                                                                                                                                                                                                      |
...
- All IPv6 IPs at port 19996. Only metric streaming requests from other Netdata agents will be accepted on this port. Only encrypted streams will be allowed (i.e. child nodes also need to be [configured for TLS](/docs/agent/src/streaming).
...
For information how to configure the child to use TLS, check [securing the communication](/docs/agent/src/streaming#securing-streaming-with-tlsssl) in the streaming documentation. There you will find additional details on the expected behavior for client and server nodes, when their respective TLS options are enabled.
