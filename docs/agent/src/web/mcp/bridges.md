...
- [`stdio-python/`](/docs/agent/src/web/mcp/stdio-python/) - Python implementation
- [`stdio-nodejs/`](/docs/agent/src/web/mcp/stdio-nodejs/) - JavaScript (Node.js) implementation 
- [`stdio-golang/`](/docs/agent/src/web/mcp/stdio-golang/) - Go implementation
