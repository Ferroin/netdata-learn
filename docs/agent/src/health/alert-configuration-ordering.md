...
1. **User config** (loaded first): your `health.d/` directory under the [Netdata config directory](/docs/agent/netdata-agent/configuration)
...
- [Overriding Stock Alerts](/docs/agent/src/health/overriding-stock-alerts)
