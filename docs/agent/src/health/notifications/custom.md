...
For the complete list of supported notification variables, see the [Alert Notification Variables](/docs/agent/src/reference#alert-notification-variables) section in the Health Reference.
