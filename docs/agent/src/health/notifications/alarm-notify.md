...
[CAPABILITIES.md](/docs/agent/src/health/notifications/capabilities) tracks the remaining Bash functionality. Configuration and code may change substantially
...
later implementation or a separate removal decision in [CAPABILITIES.md](/docs/agent/src/health/notifications/capabilities). Production Bash is unchanged.
