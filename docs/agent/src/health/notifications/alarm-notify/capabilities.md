...
- Legacy delivery maps 30 methods to typed senders, with ordered files, optional method
  ...
  unused-server gating are corrected by approval. See [the mapping table and limits](/docs/agent/src/health/notifications/alarm-notify/readme#legacy-configuration-delivery).
