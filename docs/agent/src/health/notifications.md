...
[Learn how to use `edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files)
...
- [How to configure alerts](/docs/agent/src/health/reference)
- [Notification methods list](/docs/agent/alerts-and-notifications/notifications#notification-methods)
- [Netdata configuration basics](/docs/agent/netdata-agent/configuration)
