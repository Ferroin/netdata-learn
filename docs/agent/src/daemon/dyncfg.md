...
2. **External Plugin API**: Used by go.d.plugin (see [src/plugins.d/DYNCFG.md](/docs/agent/src/plugins.d/dyncfg) for detailed documentation)
...
External plugins like go.d.plugin use a different approach based on the plugins.d protocol. For detailed information on implementing DynCfg for external plugins, please refer to the [External Plugins DynCfg documentation](/docs/agent/src/plugins.d/dyncfg).
...
[External Plugins DynCfg documentation](/docs/agent/src/plugins.d/dyncfg), section "JSON Schema for Configuration UI".
