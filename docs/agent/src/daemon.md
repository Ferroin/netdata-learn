...
For details about Netdata's logging system and configuration, see [Netdata Logging](/docs/agent/src/libnetdata/log).
...
4. [Restart](/docs/agent/netdata-agent/start-stop-restart) netdata service.
...
To modify the scheduling policy, [edit](/docs/agent/netdata-agent/configuration#edit-configuration-files) `netdata.conf`:
...
To change the timeout, [edit](/docs/agent/netdata-agent/configuration#edit-configuration-files) `netdata.conf`:
