...
|:--------|:-----|:---------------|:----------------|
| [AWS Secrets Manager](/docs/agent/src/go/plugin/agent/secrets/secretstore/backends/aws) | `aws-sm` | `secret-name[#key]` | `netdata/mysql#password` |
| [Azure Key Vault](/docs/agent/src/go/plugin/agent/secrets/secretstore/backends/azure) | `azure-kv` | `vault-name/secret-name` | `my-keyvault/mysql-password` |
| [Google Secret Manager](/docs/agent/src/go/plugin/agent/secrets/secretstore/backends/gcp) | `gcp-sm` | `project/secret[/version]` | `my-project/mysql-password` |
| [Vault](/docs/agent/src/go/plugin/agent/secrets/secretstore/backends/vault) | `vault` | `path#key` | `secret/data/netdata/mysql#password` |
