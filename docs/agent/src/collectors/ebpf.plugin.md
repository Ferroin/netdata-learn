...
1. Navigate to the [Netdata config directory](/docs/agent/netdata-agent/configuration#locate-your-config-directory).

    ```bash
    cd /etc/netdata
    ```

2. Use the [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files) script to edit `netdata.conf`.
...
2. Use the [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files) script to edit [`ebpf.d.conf`](https://github.com/netdata/netdata/blob/master/src/collectors/ebpf.plugin/ebpf.d.conf).
...
2. Use the [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files) script to edit a thread configuration file. The following configuration files are available:
