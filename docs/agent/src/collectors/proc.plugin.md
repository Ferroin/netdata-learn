...
> **Note**
>
> Temperature, fan speed, voltage and power metrics for AMD GPUs can be monitored using the [Sensors](/docs/agent/src/go/plugin/go.d/collector/sensors) plugin.
