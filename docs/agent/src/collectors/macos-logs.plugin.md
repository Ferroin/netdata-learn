...
full-text search, per-field histograms, and PLAY live tail. See [Managing Logs](/docs/dashboards-and-charts/logs-tab) for the shared workflow.
...
See [Centralizing Logs with OpenTelemetry](/docs/agent/logs/centralizing-logs-with-opentelemetry) for the setup.
