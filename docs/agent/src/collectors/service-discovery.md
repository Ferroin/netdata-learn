...
|:-----------|:-----|:-----------|:----------|
| [Docker](/docs/agent/src/go/plugin/go.d/discovery/sdext/discoverer/dockersd) | `docker` | `/etc/netdata/go.d/sd/docker.conf` | Running containers on the local Docker daemon. |
| [HTTP endpoint](/docs/agent/src/go/plugin/go.d/discovery/sdext/discoverer/httpsd) | `http` | `/etc/netdata/go.d/sd/http.conf` | Items returned by an HTTP/HTTPS endpoint (JSON or YAML). |
| [Kubernetes](/docs/agent/src/go/plugin/go.d/discovery/sdext/discoverer/k8ssd) | `k8s` | `/etc/netdata/go.d/sd/k8s.conf` | Pods and services in a Kubernetes cluster. |
| [Local listening processes](/docs/agent/src/go/plugin/go.d/discovery/sdext/discoverer/netlistensd) | `net_listeners` | `/etc/netdata/go.d/sd/net_listeners.conf` | Local processes that listen on TCP/UDP ports. |
| [SNMP](/docs/agent/src/go/plugin/go.d/discovery/sdext/discoverer/snmpsd) | `snmp` | `/etc/netdata/go.d/sd/snmp.conf` | SNMP-capable devices on configured network subnets. |
