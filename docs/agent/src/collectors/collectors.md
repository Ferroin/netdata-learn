...
Learn more about [how collectors work](/docs/agent/src/collectors), and then learn how to [enable or configure](/docs/agent/src/collectors/reference#enable-and-disable-a-specific-collection-module) a specific collector.
...
- If your application has a Prometheus endpoint, Netdata can monitor it! Look at our [generic Prometheus collector](/docs/agent/src/go/plugin/go.d/modules/prometheus).

- If your application is instrumented to expose [StatsD](https://blog.netdata.cloud/introduction-to-statsd/) metrics, see our [generic StatsD collector](/docs/agent/src/collectors/statsd.plugin).

- If you have data in CSV, JSON, XML or other popular formats, you may be able to use our [generic structured data (Pandas) collector](/docs/agent/src/collectors/python.d.plugin/pandas),
