...
following [pattern list](/docs/agent/src/libnetdata/simple_pattern):
...
[network-viewer.plugin Network Connections Topology](/docs/agent/src/collectors/network-viewer.plugin/integrations/network_connections#network-connections-topology)
