...
- [Proxmox VMs and Containers](/docs/agent/src/collectors/cgroups.plugin/integrations/proxmox_vms_and_containers)
- [Systemd Services](/docs/agent/src/collectors/cgroups.plugin/integrations/systemd_services)
- [Applications](/docs/agent/src/collectors/apps.plugin/integrations/applications)
- [ZFS Pools](/docs/agent/src/go/plugin/go.d/collector/zfspool/integrations/zfs_pools)
- [Ceph](/docs/agent/src/go/plugin/go.d/collector/ceph/integrations/ceph)
- [S.M.A.R.T.](/docs/agent/src/go/plugin/go.d/collector/smartctl/integrations/s.m.a.r.t.)
- [Network interfaces](/docs/agent/src/collectors/proc.plugin/integrations/network_interfaces)
- [Disk Statistics](/docs/agent/src/collectors/proc.plugin/integrations/disk_statistics)
- [System statistics](/docs/agent/src/collectors/proc.plugin/integrations/system_statistics)
- [Memory Usage](/docs/agent/src/collectors/proc.plugin/integrations/memory_usage)
- [ZFS Adaptive Replacement Cache](/docs/agent/src/collectors/proc.plugin/integrations/zfs_adaptive_replacement_cache)
