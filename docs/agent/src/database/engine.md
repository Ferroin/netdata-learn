...
[change how long netdata stores metrics](/docs/agent/src/database/configuration#tiers).

For how `update every` controls each tier's granularity and interacts with retention time and disk size, see [Update Every and Tier Granularity](/docs/agent/src/database/configuration#update-every-and-tier-granularity).
...
See [change how long netdata stores metrics](/docs/agent/src/database/configuration#tiers)
