...
in [FUNCTION_TOPOLOGY_DEVELOPER_GUIDE.md](/docs/agent/src/plugins.d/function_topology_developer_guide)
and [FUNCTION_TOPOLOGY_SCHEMA.json](/docs/agent/src/plugins.d/function_topology_schema.json).
...
- Canonical field definitions and origin semantics are in
  [Notifications](/docs/agent/src/plugins.d/function_topology_developer_guide#notifications).
