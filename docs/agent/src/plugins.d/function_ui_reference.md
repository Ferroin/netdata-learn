...
> **Note**: This is the technical specification. For a practical guide to implementing functions, see [Functions Developer Guide](/docs/agent/src/plugins.d/function_ui_developer_guide). Topology Functions use the dedicated [Topology Function Schema](/docs/agent/src/plugins.d/function_topology_developer_guide).
...
3. **Topology Format** (`type: "topology"`)
   ...
   - Uses [FUNCTION_TOPOLOGY_SCHEMA.json](/docs/agent/src/plugins.d/function_topology_schema.json)
