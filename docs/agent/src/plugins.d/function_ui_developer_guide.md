...
> **Note**: This is the practical developer guide. For the complete technical specification, see [Functions v3 Protocol Reference](/docs/agent/src/plugins.d/function_ui_reference). For topology Functions, use the dedicated [Topology Function Schema](/docs/agent/src/plugins.d/function_topology_developer_guide).
...
- [Topology Functions](/docs/agent/src/plugins.d/function_topology_developer_guide) - Graph payloads, evidence rows, aggregation policy, and telemetry overlays
...
This guide covers everything you need to build both simple monitoring functions and advanced log explorers. For implementation details and edge cases, see [FUNCTIONS_REFERENCE.md](/docs/agent/src/plugins.d/function_ui_reference).
