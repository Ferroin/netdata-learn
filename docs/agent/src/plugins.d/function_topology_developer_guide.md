...
The JSON Schema is [FUNCTION_TOPOLOGY_SCHEMA.json](/docs/agent/src/plugins.d/function_topology_schema.json).
...
[FUNCTION_TOPOLOGY_IMPLEMENTATION_SCOPE.md](/docs/agent/src/plugins.d/function_topology_implementation_scope).
...
- validate with [FUNCTION_TOPOLOGY_SCHEMA.json](/docs/agent/src/plugins.d/function_topology_schema.json);
