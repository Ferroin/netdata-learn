...
**Only** your web browser communicates with the Registry. If sending this information is against your policies, you can [run your own Registry](/docs/agent/src/registry/configuration)
