...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](/docs/agent/src/exporting/prometheus/remote_write)
...
of [simple patterns](/docs/agent/src/libnetdata/simple_pattern) to match the
