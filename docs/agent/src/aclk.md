...
- Activates only after you [connect a node](/docs/agent/src/claim) to your Space
...
- Learn more about [stored metadata](/docs/agent/netdata-cloud#stored-metadata)

## Enable and configure the ACLK

The Agent-Cloud Link is enabled automatically—no configuration needed.
If your Agent requires a proxy to access the internet, you'll need to [configure proxy settings](/docs/agent/src/claim#proxy-configuration).
