...
documentation](/docs/agent/src/claim).
...
However, to be able to offer the stunning visualizations and advanced functionality of Netdata Cloud, it does store a limited number of _metadata_. Read more about our [security and privacy design](/docs/agent/security-and-privacy-design).
...
connecting to cloud](/docs/agent/src/claim).
