...
[`STREAM_PATH`](/docs/agent/src/streaming/stream-path.c) entries. Each entry describes one hop in the
...
[propagation switch](/docs/agent/src/streaming/stream-path.c) at the bottom:
