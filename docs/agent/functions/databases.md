...
|----------------------|:-----------:|:---------------:|:-------------:|:----------:|--------------------------------------------------------------------------------------------|
| ClickHouse           |      ✅      |        -        |       -       |     -      | [ClickHouse](/docs/agent/src/go/plugin/go.d/collector/clickhouse/integrations/clickhouse)          |
| CockroachDB          |      ✅      |        ✅        |       -       |     -      | [CockroachDB](/docs/agent/src/go/plugin/go.d/collector/cockroachdb/integrations/cockroachdb)       |
| Couchbase            |      ✅      |        -        |       -       |     -      | [Couchbase](/docs/agent/src/go/plugin/go.d/collector/couchbase/integrations/couchbase)             |
| Elasticsearch        |      ✅      |        -        |       -       |     -      | [Elasticsearch](/docs/agent/src/go/plugin/go.d/collector/elasticsearch/integrations/elasticsearch) |
| MongoDB              |      ✅      |        -        |       -       |     -      | [MongoDB](/docs/agent/src/go/plugin/go.d/collector/mongodb/integrations/mongodb)                   |
| Microsoft SQL Server |      ✅      |        -        |       ✅       |     ✅*     | [MSSQL](/docs/agent/src/go/plugin/go.d/collector/mssql/integrations/microsoft_sql_server)          |
| MySQL                |      ✅      |        -        |       ✅       |     ✅*     | [MySQL](/docs/agent/src/go/plugin/go.d/collector/mysql/integrations/mysql)                         |
| MariaDB              |      ✅      |        -        |       ✅       |     ✅*     | [MariaDB](/docs/agent/src/go/plugin/go.d/collector/mysql/integrations/mariadb)                     |
| Percona Server       |      ✅      |        -        |       ✅       |     ✅*     | [Percona](/docs/agent/src/go/plugin/go.d/collector/mysql/integrations/percona_mysql)               |
| Oracle Database      |      ✅      |        ✅        |       -       |     -      | [Oracle](/docs/agent/src/go/plugin/go.d/collector/oracledb/integrations/oracle_db)                 |
| PostgreSQL           |      ✅      |        ✅        |       -       |    ✅**     | [PostgreSQL](/docs/agent/src/go/plugin/go.d/collector/postgres/integrations/postgresql)            |
| ProxySQL             |      ✅      |        -        |       -       |     -      | [ProxySQL](/docs/agent/src/go/plugin/go.d/collector/proxysql/integrations/proxysql)                |
| Redis                |      ✅      |        -        |       -       |     -      | [Redis](/docs/agent/src/go/plugin/go.d/collector/redis/integrations/redis)                         |
| RethinkDB            |      -      |        ✅        |       -       |     -      | [RethinkDB](/docs/agent/src/go/plugin/go.d/collector/rethinkdb/integrations/rethinkdb)             |
| YugabyteDB           |      ✅      |        ✅        |       -       |     -      | [YugabyteDB](/docs/agent/src/go/plugin/go.d/collector/yugabytedb/integrations/yugabytedb)          |
...
- [Live View](/docs/agent/top-monitoring-netdata-functions)
- [Processes Function](/docs/agent/functions/processes)
