...
For default-settings sizing guidance (CPU, RAM, disk, and bandwidth) across different workloads, see [Resource utilization](/docs/agent/netdata-agent/sizing-netdata-agents).
