...
See [Netdata MCP](/docs/agent/netdata-ai/mcp) for detailed setup instructions.
...
Generate API tokens from Netdata Cloud under **User Settings** → **API Tokens**. See [API Tokens](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens) for details.
...
See [Export Metrics to External Time-Series Databases](/docs/agent/exporting-metrics) for full connector documentation.
...
- [AI Insights: Infrastructure Summary](/docs/agent/netdata-ai/insights/infrastructure-summary)
- [AI Insights: Scheduled Reports](/docs/agent/netdata-ai/insights/scheduled-reports)
- [Investigations](/docs/agent/netdata-ai/investigations/index)
- [Netdata MCP](/docs/agent/netdata-ai/mcp)
- [API Tokens](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens)
- [Export Metrics to External Time-Series Databases](/docs/agent/exporting-metrics)
- [REST API](/docs/agent/src/web/api)
