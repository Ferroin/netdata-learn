...
[preview-collector-page](/docs/.agents/skills/integrations-lifecycle/how-tos/preview-collector-page). It uses the current
...
[delivery](/docs/.agents/skills/integrations-lifecycle/consistency#delivery-boundary-source-pr-versus-post-merge-pr).
