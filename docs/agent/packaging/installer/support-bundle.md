...
- POSIX systems (Linux, Docker, static installs, macOS/BSD best-effort):
  [`netdata-support-bundle`](/docs/agent/packaging/installer/netdata-support-bundle)
- Windows: [`netdata-support-bundle.ps1`](/docs/agent/packaging/installer/netdata-support-bundle.ps1)
...
[Collect SNMP troubleshooting data](/docs/agent/docs/npm/device-metrics/collect-snmp-troubleshooting-data)
