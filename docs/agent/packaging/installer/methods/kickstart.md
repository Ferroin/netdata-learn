...
The Netdata Agent also comes with a [CLI tool](/docs/agent/src/cli) capable of performing shutdowns. Start the Agent back up using your preferred method listed above.
