...
You can read more about this decision, or other ways to lock down the local dashboard, in our [node security documentation](/docs/netdata-agent/configuration/securing-agents).
