...
Netdata's [one-line kickstart](/docs/agent/packaging/installer) is zero-configuration, highly adaptable, and compatible with tons
...
Correlations](/docs/agent/metric-correlations), you need to set the `claim_token`
...
doc](/docs/agent/security-and-privacy-design).
