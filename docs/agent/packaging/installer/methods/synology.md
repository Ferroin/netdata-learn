...
The [one-line installation script](/docs/agent/packaging/installer/methods/kickstart) works on Synology NAS devices with amd64 architecture. The script installs Netdata to `/opt/netdata/`.
