...
> Community-maintained packages _may_ receive support from Netdata, but are only a best-effort affair. Learn more about [Netdata's platform support policy](/docs/agent/netdata-agent/versions-and-platforms).
...
area](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team#netdata-cloud-spaces).
...
- `--claim-proxy`: Specify a proxy to use when connecting to the cloud in the form of `http://[user:pass@]host:ip` for an HTTP(S) proxy.
  See [connecting through a proxy](/docs/agent/src/claim#automatically-via-a-provisioning-system-or-the-command-line) for details.
...
If you experience issues while claiming your node, follow the steps in our [Troubleshoot](/docs/agent/src/claim#troubleshoot) documentation.
