...
For offline installation on Windows, see [Install Netdata on Windows](/docs/agent/packaging/windows/windows_installer#offline-air-gapped-installation). This guide covers UNIX-like systems only.
...
The `install.sh` script accepts the [same parameters](/docs/agent/packaging/installer/methods/kickstart#optional-parameters-for-kickstartsh) as `kickstart.sh`, allowing you to customize your installation.
