...
Similarly, with our documentation on updating Netdata, you need to [determine your installation type](/docs/agent/packaging/installer/update).

:::important

**Native Package Users**

If your installation type indicates a [native package](/docs/netdata-agent/installation/linux/native-linux-distribution-packages), then proceed to uninstall Netdata using your package manager. If you want to switch to a different install type afterward, see the "Switching From a Vendor-Packaged Native Install" section under [Switching Install Types](/docs/agent/learn/switching-install-types#switching-install-types).
