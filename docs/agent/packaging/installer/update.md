...
To update Netdata, [download](/docs/agent/packaging/windows/windows_installer#download-the-windows-installer-msi) the latest installer and reinstall the Agent.

For automatic updates, see our [Windows automatic updates guide](/docs/netdata-agent/installation/windows#automatic-updates).
...
If you installed [Netdata manually from Git](/docs/agent/packaging/installer/methods/manual) run our automatic requirements installer, which works on many Linux distributions, to ensure your system has the dependencies necessary for new features.
...
For detailed instructions, see [Update your Netdata Docker container](/docs/agent/packaging/docker#update-your-netdata-docker-container).
...
This configuration file can be edited using our [`edit-config` script](/docs/agent/netdata-agent/configuration).
...
| **Docker (OCI)**           | Image pull + recreate  | See [Docker update instructions](/docs/agent/packaging/docker#update-your-netdata-docker-container)         |
