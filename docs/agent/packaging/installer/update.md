...
documentation](/docs/agent/packaging/installer#installs-on-hosts-without-ipv4-connectivity).
...
also preserves your [configuration](/docs/agent/netdata-agent/configuration) in `netdata.conf` or other files just like updating
...
script](/docs/agent/netdata-agent/configuration).
