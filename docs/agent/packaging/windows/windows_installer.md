...
2. **License Agreements**:
    - [Netdata Cloud UI License](/docs/agent/src/web/gui/v2/license): Review and accept the license terms to proceed.
    - [GPLv3 License](/docs/agent/license): Read the GNU General Public License v3, which governs the Netdata software.
...
5. **Connect to Netdata Cloud**: To [connect](/docs/agent/src/claim) your Agent to your Netdata Cloud Space you need to provide the following:
