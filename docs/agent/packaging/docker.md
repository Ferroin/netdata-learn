...
should [secure the Netdata instance](/docs/agent/netdata-agent/securing-netdata-agents). This
...
[HAProxy](/docs/agent/netdata-agent/configuration/running-the-netdata-agent-behind-a-reverse-proxy/running-behind-haproxy) or
