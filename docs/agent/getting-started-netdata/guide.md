...
## [1. Sign in & Access Your Space](/docs/agent/src/claim)
...
- **[Overview charts](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs#how-the-dashboard-is-organized)** - Automatically arranged at the start of every dashboard section to summarize its metrics
...
**[Metric Correlations](/docs/agent/metric-correlations):**
...
## [4. Customize & Set New Alerts](/docs/agent/src/health/reference)
...
## [5. Organize Your Infrastructure & Invite Your Team](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team)
...
**Team Collaboration:**
Click "Invite Users" in your Space sidebar to add team members and assign each one a role (Admin, Manager, Troubleshooter, Observer, or Billing). See [Set Up Team Access](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team#set-up-team-access) for what each role can do.
...
### [AI Capabilities That Transform Operations](/docs/agent/category-overview-pages/machine-learning-and-assisted-troubleshooting)
