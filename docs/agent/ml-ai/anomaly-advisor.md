...
- [Anomalies Tab Documentation](/docs/dashboards-and-charts/anomaly-advisor-tab)
- [Machine Learning Anomaly Detection](/docs/agent/ml-ai/ml-anomaly-detection/ml-anomaly-detection) - The foundation powering the Anomaly Advisor
