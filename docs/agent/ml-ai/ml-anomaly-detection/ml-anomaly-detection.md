...
- **[ML Configuration](/docs/agent/src/ml/ml-configuration)** - Configuration and tuning guide
- **[Metric Correlations](/docs/agent/metric-correlations)** - Finding related metrics during incidents
...
- **[Alert Troubleshooting](/docs/agent/netdata-ai/troubleshooting/index)** — generate a one-click report from any fired alert, assessing its validity, uncovering correlated signals, and proposing a root-cause hypothesis
- **[Investigations](/docs/agent/netdata-ai/investigations/index)** — ask open-ended questions about your infrastructure for deeper analysis beyond a single alert
