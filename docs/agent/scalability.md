...
- **[Deploy your first Agent](/guides/standalone-deployment)** - Start monitoring in 60 seconds
- **[Configure Parents](/guides/deployment-with-centralization-points)** - Scale to hundreds of nodes
- **[Design for Enterprise](/docs/agent/netdata-enterprise-evaluation)** - Architect for thousands
- **[Try Netdata Cloud](/docs/agent/netdata-cloud)** - Unified visibility across everything
