...
Netdata Cloud sends Alert notifications for nodes in warning, critical, or [unreachable](/docs/agent/netdata-cloud/node-states-and-transitions) states, ensuring Alerts are managed centrally and efficiently.
...
Centralized Alerts in Netdata Cloud are separate from the [Netdata Agent](/docs/agent/alerts-and-notifications/notifications) notifications. You must [configure Agent Alerts individually](/docs/agent/src/health/reference) on each node.
...
Netdata Cloud offers a silencing rule engine to mute Alert notifications based on specific conditions related to nodes or Alert types. You can manage these settings [here](/docs/agent/alerts-and-notifications/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules).
...
[For more info click here](/docs/alerts-&-notifications/alert-configuration-reference#how-to-disable-or-silence-alerts)
