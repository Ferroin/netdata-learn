...
**Want AI to handle the configuration for you?** [Alerts Automation](/docs/agent/netdata-ai/alerts-automation/alerts-automation) uses AI to suggest alerts, generate the configuration, and test it against historical data — so you can validate thresholds before deployment without writing any configuration manually.
...
- If you need help writing custom alerts, check the [full alert reference](/docs/agent/src/health/reference)
- To create alerts using natural language instead of this manual wizard, see [Alerts Automation](/docs/agent/netdata-ai/alerts-automation/alerts-automation)
