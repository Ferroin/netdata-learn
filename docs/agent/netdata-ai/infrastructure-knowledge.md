...
- [Conversations](/docs/agent/netdata-ai/conversations) — where you teach Netdata AI as you work.
- [Investigations](/docs/agent/netdata-ai/investigations/index) and [AI Insights](/docs/agent/ml-ai/ai-insights) — reports that use your context.
- [MCP Connections](/docs/agent/netdata-ai/mcp/mcp-connections) — bring in context from the tools your team already runs.
