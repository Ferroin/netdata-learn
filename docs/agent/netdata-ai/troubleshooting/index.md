...
- [Alerts Automation](/docs/agent/netdata-ai/alerts-automation/alerts-automation) (AI‑powered alert creation and suggestions)
- [Investigations](/docs/agent/netdata-ai/investigations/index) (ask open‑ended questions with rich context)
