...
It is the sibling of [`query-netdata-cloud`](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill).
...
| Domain | Guide |
|---|---|
| Generic Function invocation | [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions) |
...
| Topology (`topology:snmp`) | [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-topology) |
| Flows (`flows:netflow`) | [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-flows) |
| Alerts (v3 paths) | [query-alerts.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-alerts) |
...
| Node identity, hardware, vnodes | [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes) |
| Streaming (parent / child / replication) -- agent-only | [query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming) |
| **Operational how-tos (live catalog)** | [how-tos/INDEX.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/index) |
...
[`scripts/_lib.sh`](/docs/agent/netdata-ai/skills/query-netdata-agents/scripts/_lib.sh) that automate the bearer mint
...
1. **If you analyze, you author a how-to.** When asked a concrete
   ...
   existing how-to under [`how-tos/`](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/), you MUST author
   a new how-to and add it to
   [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/index) BEFORE completing the
...
2. **Use the token-safe wrappers.** `agents_query_cloud`,
   ...
   [`scripts/_lib.sh`](/docs/agent/netdata-ai/skills/query-netdata-agents/scripts/_lib.sh) handle auth internally
...
- All [SKILL.md prereqs from `query-netdata-cloud`](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#prerequisites):
...
- The agent's `claim_id` if you intend to mint a bearer. It's at
  ...
  [`scripts/_lib.sh`](/docs/agent/netdata-ai/skills/query-netdata-agents/scripts/_lib.sh).
...
- The agent's HTTP API path mirrors the Cloud-proxied path. For the
  ...
  [`query-netdata-cloud`](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill).
...
[`scripts/_lib.sh`](/docs/agent/netdata-ai/skills/query-netdata-agents/scripts/_lib.sh). It exposes **token-safe
