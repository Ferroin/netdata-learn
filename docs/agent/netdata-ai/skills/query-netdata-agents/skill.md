...
assistants helping them. The sibling [Cloud skill](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill) covers Cloud transport; matching
...
- **Diagnose authentication or maintain the helper:** read [authentication.md](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication) and the relevant
  symbol in [scripts/_lib.sh](/docs/agent/netdata-ai/skills/query-netdata-agents/scripts/_lib.sh). Preserve authorization already given for the current task.
...
| Domain | Read |
|---|---|
| Generic Functions and discovery | [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions) |
| Logs: systemd-journal, windows-events, macos-logs, otel-logs | [query-logs.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-logs) |
| Topology, including topology:snmp | [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-topology) |
| Network flows: flows:netflow | [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-flows) |
| Alerts through v3 paths | [query-alerts.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-alerts) |
| DynCfg: /api/v3/config | [query-dyncfg.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-dyncfg) |
| Time-series metrics: /api/v3/data | [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-metrics) |
| Node identity, hardware and vnodes | [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes) |
| Streaming, parent/child and replication | [query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming) |
| Operational recipes | [how-tos/INDEX.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/index) |
...
[Configuration](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#configuration) documents existing key roles and identity lookup.
...
[Protection And Headers](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#protection-and-headers) for status interpretation.
...
projections belong in the domain guide. [Helper Interfaces](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#helper-interfaces)
...
- During authorized implementation, you MUST update this skill or its guides for reusable, evidence-backed
  ...
  needs no separate authorization. Keep [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/index) consistent and report the updates.
