...
This guide is part of the [`query-netdata-agents`](/docs/agent/netdata-ai/skills/query-netdata-agents/skill) skill.
Read [SKILL.md](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#prerequisites) first.
...
[query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming)).

For the Cloud-side per-room enumeration (`POST
/api/v3/spaces/{sp}/rooms/{rm}/nodes`), see
[../query-netdata-cloud/query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-nodes).
...
| `GET`  | `/api/v3/nodes`               | Multi-host listing if this agent acts as a parent (see [query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming))                                    |
...
[the local flow validation recipe](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/validate-direct-local-flow-function).
...
metrics-query response (see [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-metrics))
...
status. See [query-dyncfg.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-dyncfg):
...
- **Streaming role** (parent / child) is `.host_labels._is_parent`
  ...
  lives in [query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming).

## See also

- [../query-netdata-cloud/query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-nodes)
  -- per-room / per-space node enumeration via Cloud.
- [query-dyncfg.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-dyncfg) -- DynCfg surface (jobs,
  vnodes, config).
- [query-streaming.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-streaming) -- parent/child
  streaming relationships and replication state.
- [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-metrics) -- chart-labels (per
