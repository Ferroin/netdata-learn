...
live; see
[../query-netdata-cloud/query-functions.md#frequently-registered-functions](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions#frequently-registered-functions)).
It returns:
...
[../query-netdata-cloud/query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions)
...
- **Per-stream metrics** (bandwidth, packets, dropped points) are
  ...
  context family. Use [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-metrics) to
...
- **`_is_parent` / `_is_ephemeral`** chart-labels surface the
  ...
  [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes).
...
- [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions) -- generic Function
  transport.
- [../query-netdata-cloud/query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions)
  -- canonical Function reference + envelope.
- [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes) -- node identity, parent /
  child labels.
