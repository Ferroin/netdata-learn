...
[../query-netdata-cloud/query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology).
...
- [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions) -- generic direct-agent Function
  transport.
