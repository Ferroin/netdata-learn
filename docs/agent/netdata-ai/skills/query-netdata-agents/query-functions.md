...
[../query-netdata-cloud/query-functions.md#list-available-functions](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions#list-available-functions);
