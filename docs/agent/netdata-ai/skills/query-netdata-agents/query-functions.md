...
Read [SKILL.md](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#prerequisites) first for the
...
room](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions#list-functions-on-the-nodes-in-a-room).
...
- **Bearer protection:** a 412 indicates missing required authorization for that request. The wrapper always
  ...
  [authentication reference](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#protection-and-headers).
