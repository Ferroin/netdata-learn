...
- [Direct metrics queries](/docs/agent/netdata-ai/skills/query-netdata-agents/query-metrics)
- [Direct-Agent skill](/docs/agent/netdata-ai/skills/query-netdata-agents/skill)
- [Cloud metrics sibling guide](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-metrics)
