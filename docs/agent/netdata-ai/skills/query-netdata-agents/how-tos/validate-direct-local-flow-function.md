...
- [Direct-agent skill](/docs/agent/netdata-ai/skills/query-netdata-agents/skill)
- [Direct Function calls](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions)
- [Network-flow Functions](/docs/agent/netdata-ai/skills/query-netdata-agents/query-flows)
- [Cloud flow validation sibling how-to](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/validate-local-netflow-function)
