...
- [Direct topology queries](/docs/agent/netdata-ai/skills/query-netdata-agents/query-topology)
- [Direct Function calls](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions)
- [Cloud sibling how-to](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/group-network-topology-by-kubernetes-pod)
