...
[the skill's Knowledge Capture section](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#knowledge-capture).
...
capture or project sensitive fields before display; follow [Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#safe-execution).
...
- [group-network-topology-by-kubernetes-pod-direct.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/group-network-topology-by-kubernetes-pod-direct) -- summarize `topology:network-connections` process actors by Kubernetes pod and namespace through a direct Agent call.
- [find-containers-for-topology-port-direct.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/find-containers-for-topology-port-direct) -- find containers or pods exposing a specific TCP port from the direct Agent topology Function payload.
- `flows-top-talkers-direct.md` (stub -- not yet authored)
- [validate-direct-local-flow-function.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/validate-direct-local-flow-function) -- prove a local Cloud-connected `flows:netflow` Function works through a Cloud-minted direct-agent bearer.
- [audit-stored-flow-timestamps-direct.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/audit-stored-flow-timestamps-direct) -- audit retained raw-flow timestamp and duration coverage with aggregate-only output, distinguishing exporter timing from receive-time fallback.

### Metrics

- `current-cpu-direct.md` (stub -- not yet authored)
- `peak-memory-last-hour-direct.md` (stub -- not yet authored)
- [export-cpu-io-memory-three-days-direct.md](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/export-cpu-io-memory-three-days-direct) -- export CPU, disk I/O, and memory in one-minute buckets for the 72 hours ending at 14:00 through a direct Agent call.
