...
follow [Safe Execution](/docs/agent/netdata-ai/skills/query-snmp-traps/skill#safe-execution) before displaying or sharing it.

## Implementation Owners

For source verification, the hand-maintained collector guide's
[Journal Field Contract](/docs/src/go/plugin/go.d/collector/snmp_traps/architecture#the-journal-field-contract)
...
[profile format](/docs/src/go/plugin/go.d/config/go.d/snmp.trap-profiles/profile-format) owns indexed-varbind
