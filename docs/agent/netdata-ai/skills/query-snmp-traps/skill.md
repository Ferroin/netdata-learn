...
| Task | How-to |
|---|---|
| Recent security traps from one device | [how-tos/recent-security-traps-from-device.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/recent-security-traps-from-device) |
| Critical and emergency traps across a room | [how-tos/filter-by-severity-across-fleet.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/filter-by-severity-across-fleet) |
| Top trap senders in the last hour | [how-tos/top-trap-senders-last-hour.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/top-trap-senders-last-hour) |
| Dedup summaries during a flap storm | [how-tos/inspect-dedup-summary-entries.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/inspect-dedup-summary-entries) |
| Filter by indexed varbind fields; inspect `TRAP_JSON` when needed | [how-tos/search-varbind-value-in-trap-json.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/search-varbind-value-in-trap-json) |
| Convert custom MIBs into trap profiles | [how-tos/convert-custom-mibs-to-trap-profiles.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/convert-custom-mibs-to-trap-profiles) |
| Operational how-tos catalog | [how-tos/INDEX.md](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/index) |

## Safe Execution

Credential-bearing calls MUST use the [shared Agent query helpers](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#safe-execution).
...
[Cloud logs request contract](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs)
...
[fields.md](/docs/agent/netdata-ai/skills/query-snmp-traps/fields) covers report types, severities, source identity, enrichment, indexed `TRAP_VAR_*`,
...
[configuration instructions](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#configuration) for local credentials:
...
[Agent transport contract](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#choose-the-task).
...
Use [Row Decoding](/docs/agent/netdata-ai/skills/query-snmp-traps/fields#row-decoding) for column-indexed log arrays and private decoded rows.
...
- During authorized implementation, you MUST update this skill or its guides for reusable, evidence-backed
  ...
  needs no separate authorization. Keep [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/index) consistent and report the updates.
...
- [Cloud log Function guide](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs)
- [Direct-agent log Function guide](/docs/agent/netdata-ai/skills/query-netdata-agents/query-logs)
- [Generic Function invocation through Cloud](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions)
- [Generic direct-agent Function invocation](/docs/agent/netdata-ai/skills/query-netdata-agents/query-functions)
- [SNMP trap profile format](/docs/src/go/plugin/go.d/config/go.d/snmp.trap-profiles/profile-format)
