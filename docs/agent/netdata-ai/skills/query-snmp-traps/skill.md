...
[`query-netdata-agents`](/docs/agent/netdata-ai/skills/query-netdata-agents/skill) and the
Log Function request shape from
[`query-netdata-cloud/query-logs.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs).
...
1. **If you analyze, you author a how-to.** When asked a concrete
   ...
   [`how-tos/`](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/), author a new how-to and add it to
   [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-snmp-traps/how-tos/index) before completing the
   task.
