...
[../query-netdata-agents/query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes).
...
[query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-metrics) for the cross-cutting
filter language.
...
Use [Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#safe-execution) to capture or project sensitive response fields before display.
...
[../query-netdata-agents/query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-nodes)
and [../query-netdata-agents/query-dyncfg.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-dyncfg).
...
- [query-rooms.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-rooms) -- enumerate rooms (and
  their `node_count`, `member_count`, permissions).
- [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions) -- invoke a Function
