...
[authentication reference](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#mint-and-cache-lifecycle).
...
[query-netdata-agents](/docs/agent/netdata-ai/skills/query-netdata-agents/skill) for the
mint flow).
