...
[query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions).
...
- **Function is L3-only.** No L2 visibility (use
  [topology Functions](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology) for L2). No
