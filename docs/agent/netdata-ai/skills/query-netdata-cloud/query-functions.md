...
This guide is part of the [`query-netdata-cloud`](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill) skill.
Read the [SKILL.md prerequisites](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#prerequisites) first.
...
- **Logs** family (table-history with facets+histogram):
  [query-logs.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs)
- **Topology** family (graph: actors+links):
  [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology)
- **Flows** family (network-flow records):
  [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-flows)
...
[`query-netdata-agents`](/docs/agent/netdata-ai/skills/query-netdata-agents/skill).

---

## Mandatory Requirements (READ FIRST)

Follow [Choose The Task](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#choose-the-task) for explain, review and execution requests, and
[Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#safe-execution) for local setup, credentials and response handling.
...
|---|---|---|---|
| `topology` | `data.actors`/`data.links` graph plus compact-schema sections (`data.evidence`, `data.tables`, `data.overlays`) | `topology:network-connections`, `topology:streaming`, `topology:snmp` | [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology) |
| `flows` | `data.flows[]` plus `data.facets` / `data.columns` / `data.stats` over a time window | `flows:netflow` (covers NetFlow / sFlow / IPFIX) | [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-flows) |
...
| `systemd-journal` | logs | systemd journal entries -- see [query-logs.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs) |
...
| `topology:snmp` | topology | LLDP/CDP/FDB/STP-derived L2 topology -- see [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology) |
| `flows:netflow` | flows | NetFlow / sFlow / IPFIX records -- see [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-flows) |
