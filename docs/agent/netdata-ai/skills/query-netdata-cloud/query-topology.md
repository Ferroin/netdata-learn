...
For the generic Function transport, see [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions).

Topology Functions return compact graph payloads using the production topology
schema:

- [FUNCTION_TOPOLOGY_SCHEMA.json](/docs/src/plugins.d/function_topology_schema.json)
...
- [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions) -- generic Function transport.
- [../query-netdata-agents/query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-agents/query-topology)
