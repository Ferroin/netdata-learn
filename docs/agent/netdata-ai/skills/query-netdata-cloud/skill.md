...
domain; the sibling [Agent skill](/docs/agent/netdata-ai/skills/query-netdata-agents/skill) owns direct access and the shared query helpers.
...
| Domain | Guide |
|---|---|
| Time-series metrics | [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-metrics) |
| Logs (`systemd-journal`, `windows-events`, `macos-logs`, `otel-logs`) | [query-logs.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs) |
| Topology Functions (`topology:snmp`, ...) | [query-topology.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology) |
| Network-flow Functions (`flows:netflow` -- NetFlow / sFlow / IPFIX) | [query-flows.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-flows) |
| Alerts and alert transitions | [query-alerts.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-alerts) |
| Dynamic Configuration (DynCfg) | [query-dyncfg.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-dyncfg) |
| Generic Function invocation (table snapshots + protocol taxonomy) | [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions) |
| Nodes (per-room enumeration with full metadata) | [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-nodes) |
| Rooms (per-space enumeration) | [query-rooms.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-rooms) |
| Members (per-space user enumeration) | [query-members.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-members) |
| Event feed (audit + activity log) | [query-feed.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-feed) |
| **Operational how-tos (live catalog)** | [how-tos/INDEX.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/index) |
...
[Access And Discovery](/docs/agent/netdata-ai/skills/query-netdata-cloud/access-and-discovery) covers token setup, identifier lookup and error diagnosis.
[Helper configuration](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#configuration) owns the environment keys and trusted
...
[Shared Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-agents/skill#safe-execution) owns credential and response handling.
...
[Helper Interfaces](/docs/agent/netdata-ai/skills/query-netdata-agents/authentication#helper-interfaces).
...
- During authorized implementation, you MUST update this skill or its guides for reusable, evidence-backed
  ...
  needs no separate authorization. Keep [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/index) consistent and report the updates.
