...
skill [`query-netdata-agents`](/docs/agent/netdata-ai/skills/query-netdata-agents/skill).
...
1. **If you analyze, you author a how-to.** When asked a concrete
   ...
   by an existing how-to under [`how-tos/`](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/), you MUST
   author a new how-to in this directory and add it to
   [`how-tos/INDEX.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/how-tos/index) BEFORE completing the
