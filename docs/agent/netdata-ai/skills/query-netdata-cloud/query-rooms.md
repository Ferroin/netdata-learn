...
- [query-nodes.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-nodes) -- enumerate nodes in a
  specific room.
- [query-members.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-members) -- list members of a
  space (rooms inherit space membership scoped by room
  permissions).
- [query-alerts.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-alerts) -- silencing rules
