...
review need no credentials. See [Prerequisites](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#prerequisites) and
[Access And Discovery](/docs/agent/netdata-ai/skills/query-netdata-cloud/access-and-discovery) for local setup and ID discovery.
...
> Follow [Choose The Task](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#choose-the-task) and [Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#safe-execution).
