...
| `help` / `accepted_params` / `required_params` | Discovery metadata (see [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions#infotrue-discovery)) |
