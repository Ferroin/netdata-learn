...
reference, see [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions). The
...
[query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions). Field names below are
...
| `help` / `accepted_params` / `required_params` | Discovery metadata (see [query-functions.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions#info-true-discovery)) |
