...
- [query-rooms.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-rooms) -- room-level membership
  (`isMember`, `permissions[]`, `member_count`).
- [query-feed.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-feed) -- audit-feed events include
