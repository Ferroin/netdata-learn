...
- [Topology queries](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-topology)
- [Generic Function invocation](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions)
- [Direct-agent sibling how-to](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/group-network-topology-by-kubernetes-pod-direct)
