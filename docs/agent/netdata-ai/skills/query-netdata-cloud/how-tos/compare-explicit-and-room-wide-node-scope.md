...
- [`query-metrics.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-metrics) — Scope Data request fields,
  scope/selector semantics, response structure, and query limits.
- [`query-nodes.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-nodes) — room node inventory and node metadata.
- [`SKILL.md`](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill) — authentication, token-safe wrappers, and sensitive
  data handling.
