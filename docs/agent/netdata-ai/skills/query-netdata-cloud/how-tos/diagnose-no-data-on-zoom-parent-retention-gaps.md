...
[SKILL.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill) discovery endpoints):
...
- [query-metrics.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-metrics) — request body reference
  (scope, selectors, window, aggregations, response shape)
- [query-logs.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-logs) — systemd-journal / windows-events
