...
[Safe Execution](/docs/agent/netdata-ai/skills/query-netdata-cloud/skill#safe-execution) when capturing and displaying responses.
...
- [Network-flow Functions](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-flows)
- [Generic Function invocation](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-functions)
- [Direct-agent sibling skill](/docs/agent/netdata-ai/skills/query-netdata-agents/skill)
- [Direct local flow Function validation](/docs/agent/netdata-ai/skills/query-netdata-agents/how-tos/validate-direct-local-flow-function)
