...
- [query-rooms.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-rooms), [query-members.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-members)
  -- the surfaces whose changes generate room-/member-related
  feed events.
- [query-alerts.md](/docs/agent/netdata-ai/skills/query-netdata-cloud/query-alerts) -- alert transitions are
