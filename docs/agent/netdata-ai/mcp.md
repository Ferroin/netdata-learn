...
- **Netdata as an MCP server** — AI assistants and clients (Claude, Cursor, VS Code, CLIs, and more) connect *to* Netdata to query your infrastructure. **This page** covers server setup; for per-client instructions see [Supported AI Clients](/docs/agent/netdata-ai/mcp/mcp-clients/ai-devops-copilot).
- **Netdata as an MCP client** — Netdata Cloud connects *out* to your own MCP servers (GitHub, PagerDuty, Atlassian, or any custom HTTPS MCP server) so Netdata AI can pull your team's institutional context into troubleshooting. See [MCP Connections](/docs/agent/netdata-ai/mcp/mcp-connections).
...
2. **API token** with `scope:mcp` — [Create one in API Tokens settings](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens)
...
For more details, see [API Tokens](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens).
...
For more Claude Code options — including connecting to a local Netdata Agent or Parent — see the [Claude Code guide](/docs/agent/netdata-ai/mcp/mcp-clients/claude-code).
...
[API token](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens)
(must have `scope:mcp`).
...
**Chat Clients:**
- [Claude Desktop](/docs/agent/netdata-ai/mcp/mcp-clients/claude-desktop) - Anthropic's desktop AI assistant
- [Cursor](/docs/agent/netdata-ai/mcp/mcp-clients/cursor) - AI-powered code editor
- [Visual Studio Code](/docs/agent/netdata-ai/mcp/mcp-clients/vs-code) - VS Code with MCP support
- [JetBrains IDEs](/docs/agent/netdata-ai/mcp/mcp-clients/jetbrains-ides) - IntelliJ, PyCharm, WebStorm, etc.

**DevOps Copilots:**
- [Claude Code](/docs/agent/netdata-ai/mcp/mcp-clients/claude-code) - Anthropic's CLI for Claude
- [Gemini CLI](/docs/agent/netdata-ai/mcp/mcp-clients/gemini-cli) - Google's Gemini CLI
- [OpenAI Codex CLI](/docs/agent/netdata-ai/mcp/mcp-clients/codex-cli) - OpenAI's Codex CLI
- [Crush](/docs/agent/netdata-ai/mcp/mcp-clients/crush) - Charmbracelet's glamorous terminal AI
- [OpenCode](/docs/agent/netdata-ai/mcp/mcp-clients/opencode) - SST's terminal-based AI assistant
