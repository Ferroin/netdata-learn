...
![Alert tab with Ask AI button highlighted](/docs/agent/troubleshooting/screenshot-alerts-tab-ask-ai.png)
...
![Insights tab showing Alert Troubleshooting option](/docs/agent/troubleshooting/screenshot-insights-alert-troubleshooting.png)
...
![Email notification with Troubleshoot with AI link](/docs/agent/troubleshooting/screenshot-email-troubleshoot-link.png)
