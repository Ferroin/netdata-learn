...
If the plugin isn't installed yet, follow the [Installation page](/docs/agent/npm/network-flows/installation) first.
...
For more vendors and details, see [Flow Protocols / NetFlow](/docs/agent/src/crates/netflow-plugin/integrations/netflow), [IPFIX](/docs/agent/src/crates/netflow-plugin/integrations/ipfix), and [sFlow](/docs/agent/src/crates/netflow-plugin/integrations/sflow).

## Step 2 — Open the dashboard

In your browser, open either the authenticated local Agent dashboard or the connected node in Netdata Cloud, click the **Live** tab in the top navigation, and select **Network Flows** from the Functions list. If the Agent is not connected or you are signed out, follow the [access steps](/docs/agent/npm/network-flows/installation#connect-this-agent-to-netdata-to-use-this-function).
...
- [Configuration](/docs/agent/npm/network-flows/configuration) — Tune retention after first validation; production retention should be sized from observed flow rate.
- [Static Metadata integration card](/docs/agent/src/crates/netflow-plugin/integrations/static_metadata) — Give your routers and your internal networks friendly names and labels. Without this, dashboards show raw IPs.
- [Investigation Playbooks](/docs/agent/npm/network-flows/investigation-playbooks) — Concrete recipes for the questions flow data is good at answering.
- [Anti-patterns](/docs/agent/npm/network-flows/anti-patterns) — Mistakes to avoid as you develop confidence with the data.
- [Validation and Data Quality](/docs/agent/npm/network-flows/validation) — How to confirm your numbers are correct.

For more sources or vendors:

- [NetFlow](/docs/agent/src/crates/netflow-plugin/integrations/netflow) — More vendor configurations, sampling caveats.
- [IPFIX](/docs/agent/src/crates/netflow-plugin/integrations/ipfix) — When and why to prefer IPFIX over NetFlow v9.
- [sFlow](/docs/agent/src/crates/netflow-plugin/integrations/sflow) — Different protocol, different semantics.
