...
- [Configuration](/docs/agent/npm/network-flows/configuration) — `netflow.yaml` reference.
- [Retention and Querying](/docs/agent/npm/network-flows/retention-querying) — How the four tiers store data and which fields they preserve.
- [Visualisation](/docs/agent/npm/network-flows/visualization/summary-sankey) — Reading the dashboard.
- [Validation and Data Quality](/docs/agent/npm/network-flows/validation) — How to know your data is right.
