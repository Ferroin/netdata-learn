...
- [Sankey and Table](/docs/agent/npm/network-flows/visualization/summary-sankey) — Full reference for the default view.
- [Filters and Facets](/docs/agent/npm/network-flows/visualization/filters-facets) — How to narrow effectively.
- [Time-Series](/docs/agent/npm/network-flows/visualization/time-series) — Trends over the time range.
- [Anti-patterns](/docs/agent/npm/network-flows/anti-patterns) — What "wrong" looks like and why.
- [Validation and Data Quality](/docs/agent/npm/network-flows/validation) — Confirming your numbers before acting on them.
