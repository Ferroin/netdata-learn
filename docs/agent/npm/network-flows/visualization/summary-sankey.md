...
See [Filters and Facets](/docs/agent/npm/network-flows/visualization/filters-facets) for the full mechanics.
...
- [Filters and Facets](/docs/agent/npm/network-flows/visualization/filters-facets) — Filtering mechanics in detail.
- [Time-Series](/docs/agent/npm/network-flows/visualization/time-series) — How traffic evolves over the time window.
- [Maps and Globe](/docs/agent/npm/network-flows/visualization/maps-globe) — Geographic views.
- [Field Reference](/docs/agent/npm/network-flows/field-reference) — Which fields are available for aggregation.
- [Anti-patterns](/docs/agent/npm/network-flows/anti-patterns) — How to read the numbers correctly.
