...
- [Sankey and Table](/docs/agent/npm/network-flows/visualization/summary-sankey) — The view that filters drive most often.
- [Retention and Querying](/docs/agent/npm/network-flows/retention-querying) — Why filters can shift the tier the query uses.
- [Field Reference](/docs/agent/npm/network-flows/field-reference) — Which fields are available as facets.
- [Investigation Playbooks](/docs/agent/npm/network-flows/investigation-playbooks) — Practical filter-driven workflows.
