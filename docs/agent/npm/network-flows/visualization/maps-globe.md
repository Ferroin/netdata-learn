...
- [Enrichment](/docs/agent/npm/network-flows/enrichment) — Order of evaluation and the MMDB shared mechanism that drives geographic visualisation.
- [DB-IP integration card](/docs/agent/src/crates/netflow-plugin/integrations/db-ip_ip_intelligence) — The default GeoIP source that ships with Netdata.
- [Static Metadata integration card](/docs/agent/src/crates/netflow-plugin/integrations/static_metadata) — Declare your internal networks to override GeoIP for RFC 1918.
- [Filters and Facets](/docs/agent/npm/network-flows/visualization/filters-facets) — Narrowing geographic views.
- [Anti-patterns](/docs/agent/npm/network-flows/anti-patterns) — Why "alert on traffic to country X" is fragile.
