...
- [Validation and Data Quality](/docs/agent/npm/network-flows/validation) — How to confirm your data is trustworthy.
- [Investigation Playbooks](/docs/agent/npm/network-flows/investigation-playbooks) — Step-by-step recipes for common questions.
- [Flow Protocols](/docs/agent/src/crates/netflow-plugin/integrations/netflow) — Per-protocol behaviour that drives many of these gotchas.
