...
- [Syslog from Network Devices](/docs/agent/npm/syslog) — what to expect in the Logs tab.
- [OpenTelemetry Collector Setup](/docs/agent/npm/syslog/otel-collector) — a working receiver configuration and how to
  make it durable.
- [Securing the OTLP Endpoint](/docs/agent/opentelemetry/securing-the-otlp-endpoint) — TLS and network controls for the
  receiving Agent.

Related device data under Network Performance Monitoring: [SNMP Traps](/docs/agent/npm/snmp-traps) and
[Network Flows](/docs/agent/npm/network-flows).
