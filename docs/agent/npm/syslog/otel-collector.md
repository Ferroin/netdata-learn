...
For applications, host metrics, and general file logs, use [Ingest OpenTelemetry Metrics and Logs](/docs/agent/opentelemetry/otlp-ingestion). This page remains the canonical workflow for network-device syslog.
...
- [Overview](/docs/agent/npm/syslog) — how syslog fits the centralization point.
