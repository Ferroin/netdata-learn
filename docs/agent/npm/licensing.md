...
- Licensing comes up automatically when you [monitor a device](/docs/agent/npm/device-metrics) that reports it — open its charts or the `snmp:licenses` function.
