...
Use this page to read the SNMP trap receiver metrics: whether the receiver is healthy, whether traps are flowing, and what the receiver is dropping or suppressing. For the default health alerts that ship for these metrics, see [Alerts](/docs/agent/npm/snmp-traps/alerts).
...
- [Configuration](/docs/agent/npm/snmp-traps/configuration)
- [Usage and Output](/docs/agent/npm/snmp-traps/usage-and-output)
- [Alerts](/docs/agent/npm/snmp-traps/alerts)
- [Validation and Data Quality](/docs/agent/npm/snmp-traps/validation-and-data-quality)
- [Troubleshooting](/docs/agent/npm/snmp-traps/troubleshooting)
...
For configuration details, see the [rate limiting, deduplication, and output backend sections](/docs/agent/npm/snmp-traps/configuration).
...
- If distinct resources are being collapsed together, review `dedup.key_varbinds` in [Configuration](/docs/agent/npm/snmp-traps/configuration).
...
peer or attribution is unclear. See [Journal and Querying](/docs/agent/npm/snmp-traps/journal-and-querying) for source filters
and [Field Reference](/docs/agent/npm/snmp-traps/field-reference) for the source and enrichment contracts.
...
Profile-defined metrics convert selected committed traps into time-series. They are disabled by default and must be enabled with `profile_metrics` in [Configuration](/docs/agent/npm/snmp-traps/configuration).
...
Enable only rules with bounded identity and labels. For trap row fields and deduplication summary rows, see [Usage and Output](/docs/agent/npm/snmp-traps/usage-and-output). For validation workflow and data-quality checks, see [Validation and Data Quality](/docs/agent/npm/snmp-traps/validation-and-data-quality) and [Troubleshooting](/docs/agent/npm/snmp-traps/troubleshooting).
