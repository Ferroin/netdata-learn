...
- Netdata publishes ready-to-use OpenTelemetry Collector configurations for syslog. [OpenTelemetry Collector Setup](/docs/agent/npm/syslog/otel-collector) walks through the collector configuration and what to expect in the Logs tab.
