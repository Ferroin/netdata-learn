...
[Application Dependency Mapping](/docs/agent/npm/topology/dependency-mapping) lists.
...
See [Application Dependency Mapping](/docs/agent/npm/topology/dependency-mapping) for what it maps and how to use it.
...
- The device fabric comes up once you're [monitoring devices](/docs/agent/npm/device-metrics) over SNMP.
