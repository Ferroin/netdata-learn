...
While the [Netdata dashboard](/docs/agent/src/web/gui) comes pre-configured with hundreds of charts and
...
Save the file, then navigate to your [Netdata config directory](/docs/agent/netdata-agent/configuration) to edit `netdata.conf`. Add
