...
machine](/docs/agent/src/collectors/ebpf.plugin) to help you see exactly how specific applications are interacting with the
...
[`apps.plugin`](/docs/agent/src/collectors/apps.plugin). Once you edit this file and create a new group for the application
...
Restart Netdata with `sudo systemctl restart netdata`, or the [appropriate method](/docs/agent/netdata-agent/start-stop-restart) for your system, to begin seeing metrics for this particular
...
from](/docs/agent/src/collectors/collectors).
...
The eBPF collector has [two possible modes](/docs/agent/src/collectors/ebpf.plugin#ebpf-load-mode): `entry` and `return`. The default
...
Restart Netdata with `sudo systemctl restart netdata`, or the [appropriate method](/docs/agent/netdata-agent/start-stop-restart) for your system.
...
See the [eBPF collector documentation](/docs/agent/src/collectors/ebpf.plugin#integration-with-appsplugin) for the full list
...
You can also read how to [monitor your infrastructure with Netdata Cloud](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team) to understand the key features that it has to offer.
...
find on the local Agent dashboard. Or, [create new dashboards](/docs/dashboards-and-charts/dashboards-tab) using eBPF metrics
...
team](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team#set-up-team-access) and share your findings with others.
