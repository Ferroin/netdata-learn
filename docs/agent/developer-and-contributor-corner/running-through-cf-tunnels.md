...
[Restart the Agent](/docs/agent/netdata-agent/start-stop-restart) after this change.
...
You can edit the configuration file using the `edit-config` script from the Netdata [config directory](/docs/agent/netdata-agent/configuration#locate-your-config-directory).
