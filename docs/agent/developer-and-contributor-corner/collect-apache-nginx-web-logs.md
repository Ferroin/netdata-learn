...
The [web_log](/docs/agent/src/go/plugin/go.d/modules/weblog) collector is currently compatible
...
We do have [extensive documentation](/docs/agent/src/go/plugin/go.d/modules/weblog) on how to build custom parsing for Nginx and Apache logs.
