...
- [HDFS](/docs/agent/src/go/plugin/go.d/collector/hdfs)
- [Zookeeper](/docs/agent/src/go/plugin/go.d/collector/zookeeper)
...
Finally, [restart Netdata](/docs/agent/netdata-agent/start-stop-restart).
...
For more information about editing the defaults or writing new alert entities, see our [health monitoring documentation](/docs/agent/src/health).
