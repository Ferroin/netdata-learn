...
- [Network Flows](/docs/agent/npm/network-flows) — setup and overview.
- [Retention and Querying](/docs/agent/npm/network-flows/retention-querying) — the four tiers, what each keeps, and
  reading the files with `journalctl`.
- [Configuration](/docs/agent/npm/network-flows/configuration) — listeners, enrichment, retention per tier.
- [Field Reference](/docs/agent/npm/network-flows/field-reference) — every flow field.
