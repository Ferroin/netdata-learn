...
| `Seal=` | yes | Forward Secure Sealing; see [FSS](/docs/agent/src/collectors/systemd-journal.plugin/forward_secure_sealing) |
...
[Centralizing Logs with OpenTelemetry](/docs/agent/logs/centralizing-logs-with-opentelemetry)).
...
- **[SNMP traps](/docs/agent/logs/snmp-trap-logs)** are written under `traps/<job>/<machine-id>/` in the Netdata log directory (`/var/log/netdata` on
  ...
  [Journal and Querying](/docs/agent/npm/snmp-traps/journal-and-querying) and
  [Configuration](/docs/agent/npm/snmp-traps/configuration).
- **[Network flows](/docs/agent/logs/network-flows)** (NetFlow, sFlow, IPFIX) are written under `flows/` in the Netdata cache directory
  ...
  [Retention and Querying](/docs/agent/npm/network-flows/retention-querying) and
  [Configuration](/docs/agent/npm/network-flows/configuration).
...
Edit `otel.yaml` with [`edit-config`](/docs/agent/netdata-agent/configuration#edit-configuration-files) and restart
the Agent. The full option list is in the [OpenTelemetry plugin reference](/docs/agent/src/crates/otel-plugin).
...
[Managing Logs](/docs/dashboards-and-charts/logs-tab#query-behavior-at-scale).
...
- [Centralizing Logs with OpenTelemetry](/docs/agent/logs/centralizing-logs-with-opentelemetry) — choose which sources
...
- [OpenTelemetry plugin reference](/docs/agent/src/crates/otel-plugin) — every `otel.yaml` option.
