...
If you want to **permanently remove a node** from Netdata Cloud entirely, see our guide: [Removing a node from your Netdata Cloud Space](/docs/agent/learn/remove-node)
...
**Need a claim token?** See **[Regenerate Claiming Token](/docs/agent/src/claim#regenerate-claiming-token)** to generate a new token for your Space (Space Administrator required).

:::

## Step 1: Unclaim from Current Space

See our **[Reconnect Agent](/docs/agent/src/claim#reconnect-agent)** guide for the exact commands to:
...
- [Remove a node from Netdata Cloud entirely](/docs/agent/learn/remove-node) - For permanent node removal
- [Connect Agent to Cloud](/docs/agent/src/claim) - Initial connection setup
- [Reconnect Agent](/docs/agent/src/claim#reconnect-agent) - Linux/ Docker-based installations
