...
| `scope:mcp`            | Used to connect MCP clients (Claude Desktop, Cursor, etc.) to [Netdata Cloud MCP](/docs/agent/netdata-ai/mcp#netdata-cloud-mcp) for AI-assisted monitoring | Access to MCP server endpoints     |
