...
| Requirement        | Details                                                                                                                                                         |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **SSO Provider**   | Must be [supported by Netdata](/docs/netdata-cloud/authentication-&-authorization/cloud-authentication-&-authorization-integrations) |
...
See [Authentication & Authorization](/docs/agent/netdata-cloud/authentication-and-authorization#multi-factor-authentication-mfa) for MFA availability by sign-in method.
