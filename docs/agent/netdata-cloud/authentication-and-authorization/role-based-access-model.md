...
The **Groups** tab under **User Management** only appears after [SCIM integration](/docs/agent/integrations/cloud-authentication/integrations/scim) is enabled. It is not shown by default, even on paid plans. Enabling SCIM requires a paid plan, a configured [Enterprise SSO (OIDC/SSO) integration](/docs/agent/netdata-cloud/authentication-and-authorization/enterprise-sso-authentication), and Space Administrator access. If you don't see the **Groups** tab, set up Enterprise SSO first, then activate SCIM.
...
| **Edit configuration**                                                        | :heavy_check_mark: |         -          |         -          |         -          |         -          | Some exceptions apply depending on [service level](/docs/agent/alerts-and-notifications/notifications/centralized-cloud-notifications/manage-notification-methods#available-actions-per-notification-method-based-on-service-level) |
| **Delete configuration**                                                      | :heavy_check_mark: |         -          |         -          |         -          |         -          |                                                                                                                                                                                                                                  |
| **Edit personal level notification settings**                                 | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | [Manage user notification settings](/docs/agent/alerts-and-notifications/notifications/centralized-cloud-notifications/manage-notification-methods#manage-user-notification-settings)                                               |
...
Enable, Edit and Add actions over specific notification methods will only be allowed if your plan has access to those (see [service classification](/docs/agent/alerts-and-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-classification))
