...
> - Plan changes, including downgrades or cancellations, may impact notification settings or user access. More details at [Plan changes and credit balance](/docs/agent/netdata-cloud/view-plan-and-billing#plan-changes-and-credit-balance).
