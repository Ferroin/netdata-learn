...
| **Enterprise SSO** | • Advanced authentication for organizations using identity providers<br/>• Features:<br/>&emsp; - Identity provider integration<br/>&emsp; - Centralized management<br/>&emsp; - Enhanced security<br/>&emsp; - Audit logging | See [Enterprise SSO documentation](/docs/agent/netdata-cloud/authentication-and-authorization/enterprise-sso-authentication)  |
...
For organizations that require MFA for all users, [Enterprise SSO](/docs/agent/netdata-cloud/authentication-and-authorization/enterprise-sso-authentication) delegates authentication entirely to your identity provider, which can enforce MFA policies centrally.
