...
- **Testing Netdata?** → [Docker deployment](/docs/agent/packaging/docker) (2 minutes, easy cleanup)
- **Monitoring one server?** → [Standalone installation](/guides/standalone-deployment) (1 minute, upgradeable)
- **Production ready?** → [Parent-Child setup](/guides/deployment-with-centralization-points) (recommended)
...
[→ Deploy Standalone Agent](/guides/standalone-deployment)
...
[→ Deploy Parent-Child Setup](/guides/deployment-with-centralization-points)
...
[→ Deploy with Docker](/docs/agent/packaging/docker)

## Which Deployment Should I Choose?

| Environment             | Recommended Method                                                                                                                                                 | Why                                                                 |
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Production servers**  | [Parent-Child](/guides/deployment-with-centralization-points)                                                                                   | Best data persistence, resource optimization, and high availability |
...
| **Testing/Development** | [Standalone](/guides/standalone-deployment) or [Docker](/docs/agent/packaging/docker)                                                            | Quick setup, easy to remove                                         |
| **Single server**       | [Standalone](/guides/standalone-deployment) (upgrade to [Parent-Child](/guides/deployment-with-centralization-points) later) | Start simple, upgrade when ready for production                     |
