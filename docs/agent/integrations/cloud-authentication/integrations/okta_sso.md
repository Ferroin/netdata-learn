...
If you start your authentication flow from Netdata sign-in page please check [these steps](/docs/agent/netdata-cloud/authentication-and-authorization/enterprise-sso-authentication#from-netdata-sign-up-page).
