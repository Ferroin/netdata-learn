...
|:------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------|
| Netdata is the only consumer of host or application metrics                         | Use Netdata's [native collectors](/docs/agent/src/collectors/collectors)                             |
...
| Network devices send syslog                                                         | Use the dedicated [OpenTelemetry Collector syslog setup](/docs/agent/npm/syslog/otel-collector) |
...
For production pipelines beyond these smoke tests, continue with [Metrics Collection](/docs/agent/opentelemetry/metrics-collection), [Logs Collection](/docs/agent/opentelemetry/logs-collection), and [Transformations](/docs/agent/opentelemetry/transformations). Each page links its examples to the complete upstream Collector documentation.
...
does and does not protect are in [Securing the OTLP Endpoint](/docs/agent/opentelemetry/securing-the-otlp-endpoint). See
the [OpenTelemetry plugin reference](/docs/agent/src/crates/otel-plugin) for every option.
...
For plugin-specific diagnosis, use the [OpenTelemetry plugin reference](/docs/agent/src/crates/otel-plugin). To derive a metric from matching log records, continue with [Create metrics from OpenTelemetry logs](/docs/agent/opentelemetry/logs-to-metrics).
