...
If you receive an error saying that your node can't execute Functions, check the [prerequisites](/docs/agent/top-monitoring-netdata-functions) to ensure your node is configured properly.
