...
At any time, [configure the internal TSDB's storage capacity](/docs/agent/netdata-agent/configuration/optimizing-metrics-database/change-metrics-storage) to expand your
