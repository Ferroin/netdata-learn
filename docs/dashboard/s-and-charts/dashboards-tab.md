...
Can't find a dashboard? Dashboards belong to a specific [Room](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team#create-your-first-room), and each Room keeps its own separate dashboards. A dashboard that appears to be missing is often in another Room — check the **Dashboards** tab in each Room to locate it.
...
- **Token Management**: TV Mode tokens can be viewed and revoked in **User Settings > API Tokens**. Learn more in the [API Tokens documentation](/docs/agent/netdata-cloud/authentication-and-authorization/api-tokens).
...
After designing your dashboards, [invite your team](/docs/agent/netdata-cloud/organize-your-infrastructure-invite-your-team#set-up-team-access) to collaborate. Add new users to the same Room so they can view and interact with your dashboards effortlessly.
