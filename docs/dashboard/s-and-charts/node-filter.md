...
For a complete explanation of node states, transitions, and cleanup rules, see [Node States and Transitions](/docs/agent/netdata-cloud/node-states-and-transitions).
